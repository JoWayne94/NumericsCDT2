"""
2D advection diffusion convergence test by varying h
...
if __name__ == '__main__':
    ...
    for nn in range(len(nnodes_list)):
        ...
        L2_errors[nn] = compute_l2_err(u, u_exact, h)
    ...
    plt.plot(np.array(nnodes_list) - 1, L2_errors, line_colours[0],
             label='Numerical', lw=lw, ms=ms, fillstyle='none')
