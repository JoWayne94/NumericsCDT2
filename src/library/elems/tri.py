...
from src.library.refs.tri import RefTri
from src.library.geoms.tri import Triangle as TriGeom


class Triangle(Elem):
    """
    @:brief 2D implementation of a straight-sided triangle
    """
    ...
    def __init__(self, ien, nodes, neighbour_labels, n_vars, source, p1, p2):
        ...
        self.ref_elem = RefTri("GLL", p1, p2)
        ...
        # Geometric data
        self.geoms.geometry = TriGeom(self.geom_data.nodes,
        ...
        """
        self.mats.basis_matrix, self.mats.deriv_matrix = Lagrange2dTri(self.ref_elem.zeros,
                                                                       self.ref_elem.zeros, p1) # check
    ...
    def calculate_face_normals(self):
        """
        @:brief Unit face normals of all faces [F0, F1, F2]
    ...
    def get_stiffness_matrix(self):
        ...
        return [stiffness_x.T, stiffness_y.T]
